...
PmergeMeVector::PmergeMeVector(PmergeMeVector &other) { (void)other; }

PmergeMeVector &PmergeMeVector::operator=(PmergeMeVector &other) { (void)other; return (*this); }
...
PmergeMeList::PmergeMeList(PmergeMeList &other) { (void)other; }

PmergeMeList &PmergeMeList::operator=(PmergeMeList &other) { (void)other; return (*this); }
...
PmergeMeDeque::PmergeMeDeque(PmergeMeDeque &other) { (void)other; }

PmergeMeDeque &PmergeMeDeque::operator=(PmergeMeDeque &other) { (void)other; return (*this); }
